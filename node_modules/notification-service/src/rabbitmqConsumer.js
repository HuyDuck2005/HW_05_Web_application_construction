...
const QUEUE = process.env.NOTIFICATION_QUEUE ?? 'notification.course.enrolled_count_increased.queue';
const ROUTING_KEY = process.env.COURSE_EVENT_ROUTING_KEY ?? 'course.enrolled_count_increased';
...
export async function startNotificationConsumer() {
  ...
  await channel.consume(
    QUEUE,
    async (msg) => await handleMessage(msg),
    { noAck: false }
  );
